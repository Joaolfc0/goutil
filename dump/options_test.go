...
// see https://github.com/Joaolfc0/goutil/issues/41
...
// see https://github.com/Joaolfc0/goutil/issues/74
func TestBytesAsString(t *testing.T) {
	...
	/* Output:
	PRINT AT github.com/Joaolfc0/goutil/dump.TestBytesAsString(options_test.go:28)
	[]uint8 [ #len=5,cap=5
	  uint8(104),
	  uint8(101),
	  uint8(108),
	...
	*/
	...
	/*Output:
	PRINT AT github.com/Joaolfc0/goutil/dump.TestBytesAsString(options_test.go:49)
